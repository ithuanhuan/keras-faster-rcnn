...
#首先是rpn网络训练原始图片信息，获得损失，预测原始图片，获得boudingbox信息。
#然后 再分为正样本boudingbox 和 负样本boundingbox ，然后将所有的样本加在一起去使用模型分类模型网络去训练，得到分类损失
...
def test_kitti():
    ...
    log_path = './graph'
    callback = TensorBoard(log_path, histogram_freq=0,
    ...
    for epoch_num in range(num_epochs):
        ...
        while True:
            try:
                ...
                X2, Y1, Y2, IouS, count  = roi_helpers.calc_iou(result, img_data, cfg, class_mapping)
